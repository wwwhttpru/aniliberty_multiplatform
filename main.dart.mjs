...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1339: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1339(f,arguments.length,x0,x1) }),
      _1340: x0 => ({xhrSetup: x0}),
      _1341: x0 => new Hls(x0),
      _1342: (x0,x1) => x0.attachMedia(x1),
      _1343: (x0,x1) => x0.loadSource(x1),
      _1344: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1344(f,arguments.length,x0,x1) }),
      _1345: (x0,x1,x2) => x0.on(x1,x2),
      _1346: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1346(f,arguments.length,x0,x1) }),
      _1347: x0 => x0.play(),
      _1348: x0 => x0.pause(),
      _1349: (x0,x1) => x0.removeAttribute(x1),
      _1350: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1351: x0 => x0.load(),
      _1352: x0 => x0.stopLoad(),
      _1353: (x0,x1) => x0.start(x1),
      _1354: (x0,x1) => x0.end(x1),
      _1355: (x0,x1) => x0.canPlayType(x1),
      _1356: () => globalThis.Hls.isSupported(),
      _1357: x0 => x0.preventDefault(),
      _1358: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1358(f,arguments.length,x0) }),
      _1359: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1360: (x0,x1,x2) => x0.setAttribute(x1,x2),
