...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1347: x0 => ({xhrSetup: x0}),
      _1348: x0 => new Hls(x0),
      _1349: (x0,x1) => x0.attachMedia(x1),
      _1350: (x0,x1) => x0.loadSource(x1),
      _1351: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1351(f,arguments.length,x0,x1) }),
      _1352: (x0,x1,x2) => x0.on(x1,x2),
      _1353: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1353(f,arguments.length,x0,x1) }),
      _1354: x0 => x0.play(),
      _1355: x0 => x0.pause(),
      _1356: (x0,x1) => x0.removeAttribute(x1),
      _1357: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1358: x0 => x0.load(),
      _1359: x0 => x0.stopLoad(),
      _1360: (x0,x1) => x0.start(x1),
      _1361: (x0,x1) => x0.end(x1),
      _1362: (x0,x1) => x0.canPlayType(x1),
      _1363: () => globalThis.Hls.isSupported(),
      ...
      _1367: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1368: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1368(f,arguments.length,x0) }),
      _1369: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1370: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1371: (x0,x1) => x0.createElement(x1),
      _1376: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1377: (x0,x1) => x0.removeItem(x1),
      _1379: (x0,x1) => x0.getItem(x1),
      _1380: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1381: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1382: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1383: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1384: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1385: (x0,x1,x2) => x0.setItem(x1,x2),
      _1386: (x0,x1) => x0.getRandomValues(x1),
      _1387: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1388: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1389: Date.now,
      ...
      _1405: x0 => new FinalizationRegistry(x0),
      _1406: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1408: (x0,x1) => x0.unregister(x1),
      _1410: () => globalThis.WeakRef,
      _1411: () => globalThis.FinalizationRegistry,
      _1413: x0 => x0.call(),
      ...
      _1582: x0 => new WebAssembly.Memory(x0),
      _1583: x0 => x0.buffer,
      ...
      _1596: x0 => x0.sqlite3_error_offset,
      ...
      _1609: (x0,x1) => x0.sqlite3_stmt_isexplain(x1),
      ...
      _1615: (x0,x1,x2,x3,x4,x5) => x0.sqlite3_bind_blob64(x1,x2,x3,x4,x5),
      _1616: (x0,x1,x2,x3) => x0.sqlite3_bind_double(x1,x2,x3),
      _1617: (x0,x1,x2,x3) => x0.sqlite3_bind_int64(x1,x2,x3),
      _1618: (x0,x1,x2) => x0.sqlite3_bind_null(x1,x2),
      _1619: (x0,x1,x2,x3,x4,x5) => x0.sqlite3_bind_text(x1,x2,x3,x4,x5),
      _1620: (x0,x1,x2) => x0.sqlite3_column_blob(x1,x2),
      _1621: (x0,x1,x2) => x0.sqlite3_column_double(x1,x2),
      _1622: (x0,x1,x2) => x0.sqlite3_column_int64(x1,x2),
      _1623: (x0,x1,x2) => x0.sqlite3_column_text(x1,x2),
      _1624: (x0,x1,x2) => x0.sqlite3_column_bytes(x1,x2),
      _1625: (x0,x1,x2) => x0.sqlite3_column_type(x1,x2),
      _1626: (x0,x1) => x0.sqlite3_value_blob(x1),
      _1627: (x0,x1) => x0.sqlite3_value_double(x1),
      _1628: (x0,x1) => x0.sqlite3_value_type(x1),
      _1629: (x0,x1) => x0.sqlite3_value_int64(x1),
      _1630: (x0,x1) => x0.sqlite3_value_text(x1),
      _1631: (x0,x1) => x0.sqlite3_value_bytes(x1),
      _1634: (x0,x1) => x0.sqlite3_user_data(x1),
      _1635: (x0,x1,x2,x3,x4) => x0.sqlite3_result_blob64(x1,x2,x3,x4),
      _1636: (x0,x1,x2) => x0.sqlite3_result_double(x1,x2),
      _1637: (x0,x1,x2,x3) => x0.sqlite3_result_error(x1,x2,x3),
      _1638: (x0,x1,x2) => x0.sqlite3_result_int64(x1,x2),
      _1639: (x0,x1) => x0.sqlite3_result_null(x1),
      _1640: (x0,x1,x2,x3,x4) => x0.sqlite3_result_text(x1,x2,x3,x4),
      _1641: x0 => x0.sqlite3_result_subtype,
      _1660: (x0,x1) => x0.dart_sqlite3_malloc(x1),
      _1661: (x0,x1) => x0.dart_sqlite3_free(x1),
      _1662: (x0,x1,x2,x3) => x0.dart_sqlite3_register_vfs(x1,x2,x3),
      _1663: (x0,x1,x2,x3,x4,x5) => x0.dart_sqlite3_create_scalar_function(x1,x2,x3,x4,x5),
      _1666: x0 => x0.dart_sqlite3_updates,
      _1667: x0 => x0.dart_sqlite3_commits,
      _1668: x0 => x0.dart_sqlite3_rollbacks,
      _1672: x0 => ({initial: x0}),
      ...
      _1713: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1714: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1716: (x0,x1) => ({i: x0,p: x1}),
      _1717: (x0,x1) => ({c: x0,r: x1}),
      _1718: x0 => x0.i,
      _1719: x0 => x0.p,
      _1720: x0 => x0.c,
      _1721: x0 => x0.r,
      _1722: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1722(f,arguments.length,x0) }),
      _1723: (x0,x1) => x0.postMessage(x1),
      _1724: x0 => x0.close(),
      _1726: x0 => new Worker(x0),
      _1728: x0 => x0.getDirectory(),
      _1729: x0 => ({create: x0}),
      _1730: (x0,x1,x2) => x0.getFileHandle(x1,x2),
      _1731: x0 => x0.createSyncAccessHandle(),
      _1732: x0 => x0.close(),
      _1735: x0 => x0.close(),
      _1738: (x0,x1,x2) => x0.open(x1,x2),
      _1742: (x0,x1,x2) => x0.getDirectoryHandle(x1,x2),
      _1747: x0 => ({create: x0}),
      _1752: (x0,x1) => new SharedWorker(x0,x1),
      _1753: x0 => x0.start(),
      _1754: x0 => x0.terminate(),
      _1755: () => new MessageChannel(),
      _1759: x0 => new SharedArrayBuffer(x0),
      _1760: x0 => ({at: x0}),
      _1761: x0 => x0.getSize(),
      _1762: (x0,x1) => x0.truncate(x1),
      _1763: x0 => x0.flush(),
      _1766: x0 => x0.synchronizationBuffer,
      _1767: x0 => x0.communicationBuffer,
      _1768: (x0,x1,x2,x3) => ({clientVersion: x0,root: x1,synchronizationBuffer: x2,communicationBuffer: x3}),
      _1769: (x0,x1) => globalThis.IDBKeyRange.bound(x0,x1),
      _1770: x0 => ({autoIncrement: x0}),
      _1771: (x0,x1,x2) => x0.createObjectStore(x1,x2),
      _1772: x0 => ({unique: x0}),
      _1773: (x0,x1,x2,x3) => x0.createIndex(x1,x2,x3),
      _1774: (x0,x1) => x0.createObjectStore(x1),
      _1775: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1775(f,arguments.length,x0) }),
      _1776: (x0,x1,x2) => x0.transaction(x1,x2),
      _1777: (x0,x1) => x0.objectStore(x1),
      _1779: (x0,x1) => x0.index(x1),
      _1780: x0 => x0.openKeyCursor(),
      _1781: (x0,x1) => x0.getKey(x1),
      _1782: (x0,x1) => ({name: x0,length: x1}),
      _1783: (x0,x1) => x0.put(x1),
      _1784: (x0,x1) => x0.get(x1),
      _1785: (x0,x1) => x0.openCursor(x1),
      _1786: x0 => globalThis.IDBKeyRange.only(x0),
      _1787: (x0,x1,x2) => x0.put(x1,x2),
      _1788: (x0,x1) => x0.update(x1),
      _1789: (x0,x1) => x0.delete(x1),
      _1790: x0 => x0.name,
      _1791: x0 => x0.length,
      _1794: x0 => x0.continue(),
      _1795: () => globalThis.indexedDB,
      _1796: () => globalThis.navigator,
      _1797: (x0,x1) => x0.read(x1),
      _1798: (x0,x1,x2) => x0.read(x1,x2),
      _1799: (x0,x1) => x0.write(x1),
      _1800: (x0,x1,x2) => x0.write(x1,x2),
      _1802: (x0,x1,x2) => globalThis.Atomics.wait(x0,x1,x2),
      _1804: (x0,x1,x2) => globalThis.Atomics.notify(x0,x1,x2),
      _1805: (x0,x1,x2) => globalThis.Atomics.store(x0,x1,x2),
      _1806: (x0,x1) => globalThis.Atomics.load(x0,x1),
      _1807: () => globalThis.Int32Array,
      _1809: () => globalThis.Uint8Array,
      _1811: () => globalThis.DataView,
      _1813: x0 => x0.byteLength,
      _1815: x0 => globalThis.BigInt(x0),
      _1816: x0 => globalThis.Number(x0),
      _1823: x0 => new BroadcastChannel(x0),
      _1824: x0 => globalThis.Array.isArray(x0),
      _1825: (x0,x1) => x0.postMessage(x1),
      _1826: x0 => x0.close(),
      _1827: (x0,x1) => ({kind: x0,table: x1}),
      _1828: x0 => x0.kind,
      _1829: x0 => x0.table,
      ...
      _1846: f => finalizeWrapper(f, function() { return dartInstance.exports._1846(f,arguments.length) }),
      _1847: f => finalizeWrapper(f, function() { return dartInstance.exports._1847(f,arguments.length) }),
      _1848: x0 => x0.requestFullscreen(),
      _1849: x0 => x0.exitFullscreen(),
      ...
      _1857: x0 => x0.getReader(),
      _1858: x0 => x0.cancel(),
      _1859: x0 => x0.read(),
      _1869: x0 => x0.random(),
      _1870: (x0,x1) => x0.getRandomValues(x1),
      _1871: () => globalThis.crypto,
      _1872: () => globalThis.Math,
      _1882: Function.prototype.call.bind(Number.prototype.toString),
      _1883: Function.prototype.call.bind(BigInt.prototype.toString),
      _1884: Function.prototype.call.bind(Number.prototype.toString),
      _1885: (d, digits) => d.toFixed(digits),
      _1969: x0 => x0.readyState,
      _1971: (x0,x1) => { x0.timeout = x1 },
      _1973: (x0,x1) => { x0.withCredentials = x1 },
      _1974: x0 => x0.upload,
      _1975: x0 => x0.responseURL,
      _1976: x0 => x0.status,
      _1977: x0 => x0.statusText,
      _1979: (x0,x1) => { x0.responseType = x1 },
      _1980: x0 => x0.response,
      _1992: x0 => x0.loaded,
      _1993: x0 => x0.total,
      _2057: x0 => x0.style,
      _2629: x0 => x0.videoWidth,
      _2630: x0 => x0.videoHeight,
      _2634: (x0,x1) => { x0.playsInline = x1 },
      _2659: x0 => x0.error,
      _2661: (x0,x1) => { x0.src = x1 },
      _2670: x0 => x0.buffered,
      _2673: x0 => x0.currentTime,
      _2674: (x0,x1) => { x0.currentTime = x1 },
      _2675: x0 => x0.duration,
      _2680: (x0,x1) => { x0.playbackRate = x1 },
      _2687: (x0,x1) => { x0.autoplay = x1 },
      _2689: (x0,x1) => { x0.loop = x1 },
      _2691: (x0,x1) => { x0.controls = x1 },
      _2693: (x0,x1) => { x0.volume = x1 },
      _2695: (x0,x1) => { x0.muted = x1 },
      _2709: (x0,x1) => { x0.disableRemotePlayback = x1 },
      _2710: x0 => x0.code,
      _2711: x0 => x0.message,
      _2784: x0 => x0.length,
      _3757: () => globalThis.window,
      _3819: x0 => x0.navigator,
      _4074: x0 => x0.isSecureContext,
      _4077: x0 => x0.crypto,
      _4082: x0 => x0.sessionStorage,
      _4083: x0 => x0.localStorage,
      _4208: x0 => x0.userAgent,
      _4221: x0 => x0.storage,
      _4259: x0 => x0.data,
      _4289: x0 => x0.port1,
      _4290: x0 => x0.port2,
      _4292: (x0,x1) => { x0.onmessage = x1 },
      _4370: x0 => x0.port,
      _6350: x0 => x0.signal,
      _6424: () => globalThis.document,
      _6484: x0 => x0.documentElement,
      _6487: x0 => x0.fullscreenEnabled,
      _6547: x0 => x0.fullscreenElement,
      _6839: (x0,x1) => { x0.id = x1 },
      _8185: x0 => x0.value,
      _8187: x0 => x0.done,
      _8867: x0 => x0.url,
      _8869: x0 => x0.status,
      ...
      _10329: x0 => x0.result,
      _10330: x0 => x0.error,
      _10341: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10343: x0 => x0.oldVersion,
      _10422: x0 => x0.key,
      _10423: x0 => x0.primaryKey,
      _10425: x0 => x0.value,
